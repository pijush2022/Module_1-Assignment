"""
Quick test script that uses U-Net for wall segmentation instead of SAM.
"""
...
def test_with_unet():
    """Test the pipeline with U-Net enabled."""
    ...
    print("🧠 Using U-Net for enhanced wall segmentation")
    
    try:
        from wall_ar_pipeline import WallARPipeline
        from product_placement import ProductType
        
        # Initialize pipeline with U-Net (no checkpoint path needed)
        ...
        result = pipeline.process_image(
            ...
            output_path="output/results/unet_test_result.png",
            enable_shadows=True,
        ...
        print(f"   Output: output/results/unet_test_result.png")
